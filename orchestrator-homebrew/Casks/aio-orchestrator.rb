cask "aio-orchestrator" do
  version "1.0.0"

  # Note: Update sha256 values after building release artifacts
  # Use: shasum -a 256 "AIO Orchestrator_*.dmg"
  on_arm do
    sha256 "PLACEHOLDER_ARM64_SHA256"
    url "https://github.com/OWNER/orchestrator/releases/download/v#{version}/AIO.Orchestrator_#{version}_aarch64.dmg"
  end

  on_intel do
    sha256 "PLACEHOLDER_X64_SHA256"
    url "https://github.com/OWNER/orchestrator/releases/download/v#{version}/AIO.Orchestrator_#{version}_x64.dmg"
  end
