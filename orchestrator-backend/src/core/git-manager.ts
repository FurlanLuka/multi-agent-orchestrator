...
export class GitManager {
  ...
  /**
   * Ensures Orchy entries are in .gitignore
  ...
  private ensureGitignore(projectPath: string): void {
    ...
    for (const entry of ORCHY_GITIGNORE_ENTRIES) {
    ...
    // Add a blank line before Orchy section if content exists
    ...
    console.log(`[GitManager] Added Orchy entries to .gitignore at ${expandedPath}`);
  }
  ...
  async commit(
    ...
    // Ensure .gitignore has Orchy entries before committing
